        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-8">
          ...
          <div className="flex flex-col items-start md:items-start text-left">
            ...
            <ul className="space-y-3 md:space-y-4 text-white/80 text-sm break-words hyphens-auto pr-2">
              ...
              <li>80331 München</li>
              <li className="pt-4"><a href="mailto:info@maurer-events.de" className="hover:text-white transition-colors block border-b border-white/20 pb-2 inline-block">info@maurer-events.de</a></li>
              <li><a href="tel:+49123456789" className="hover:text-white transition-colors block">+49 (0) 123 456 789</a></li>
            </ul>
          </div>
        </div>
      </div>
