    ...
    >
      ...
      <motion.div 
        ...
        style={{
          ...
          transformOrigin: "50% 21.7%" // Exakt auf Höhe der Stange (y=100 von 460)
        }}
      >
        <svg viewBox="0 0 240 460" className="w-full h-auto overflow-visible">
          {/* Horizontal Metal Rod */}
          <line x1="5" y1="100" x2="235" y2="100" stroke="#4A4A4A" strokeWidth="8" strokeLinecap="round" />
          
          {/* Banner Background */}
          <polygon points="20,104 220,104 220,400 120,460 20,400" fill="#FFFFFF" />
        {/* Banner Inner Border */}
        <polygon points="32,116 208,116 208,393 120,446 32,393" fill="none" stroke="#1F5732" strokeWidth="4" />
      </svg>
      {/* Content overlay */}
      <div className="absolute top-[22%] left-0 w-full h-[78%] pb-[25%] pt-8 px-6 flex flex-col items-center justify-start pointer-events-none">
        <img src="/figur-transparent.png" alt="Festwirt Figur" className="w-full h-auto object-contain mb-2 filter drop-shadow-md" />
        
        <div className="mt-auto mb-4 md:mb-8 lg:mb-10 flex flex-col items-end">
          <h4 className="font-display font-black text-right text-accent-green text-sm md:text-lg lg:text-xl leading-none tracking-widest uppercase">
            MAURER<br/>EVENTS
          </h4>
          <span className="font-sans text-accent-green text-[8px] md:text-[10px] lg:text-xs mt-1 opacity-90 tracking-widest">
            est. 2025
          </span>
        </div>
      </div>
